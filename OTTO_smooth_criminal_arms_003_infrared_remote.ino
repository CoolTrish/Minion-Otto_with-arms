...
void walk(int steps, int T = 2000);
void backyard(int steps, int T = 3000);
void backyardSlow(int steps, int T = 5000);
void turnLeft(int steps, int T = 3000);
void turnRight(int steps, int T = 3000);
void moonWalkLeft(int steps, int T = 2000);
void moonWalkRight(int steps, int T = 2000);
void crusaito(int steps, int T = 1000);
void swing(int steps, int T = 1000);
void upDown(int steps, int T = 2000);
void flapping(int steps, int T = 3000);
...
void primera_parte() {
  ...
  for (int x = 0; x < 3; x++) {
    for (int i = 0; i < 3; i++) {
      lateral_fuerte(1, t / 2); //Lateral_strong
